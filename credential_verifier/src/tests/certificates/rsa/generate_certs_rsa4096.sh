...
openssl genpkey -algorithm RSA -pkeyopt rsa_keygen_bits:4096 -out ewqwe.user1.key.pem
...
openssl genpkey -algorithm RSA -pkeyopt rsa_keygen_bits:4096 -out ewqwe.user2.key.pem
